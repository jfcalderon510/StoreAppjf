...
final class ProductFormModel {
  ...
  ProductFormModel({required this.id, required this.name, required this.price, required this.urlImage});
  ...
  ProductEntity toEntity() => ProductEntity(id: id, name: name, image: urlImage, price: int.parse(price) );
}
